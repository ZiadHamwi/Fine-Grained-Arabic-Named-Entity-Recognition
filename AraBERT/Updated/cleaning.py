...
#     recleaned[0] are the sentences and recleaned[1] are the tags
#                 print(recleaned[0])
                ...
                line = line.split(sep=' ')
#                 line[0] is the word and line[1] is the tag
#                 print(line[1])
                clean_word = cleaner.clean_text(line[1])       # Cleaning word
#                 print(clean_word)
                sentence.append(clean_word)           # Add the word
                entity.append(cleaner.remove_line(line[0]))  # Clean and add entity
